...
public class AdvancedAnnotationFeaturePack extends FeaturePack<Annotation> {
	...
	public static HashMap<String, Double> getFeaturesStatic(Annotation a, String query, QueryInformation qi, WikipediaApiInterface wikiApi) {
		...
		features.put("edit_distance_anchor_segment_sqrt_geometric_0.20", edAnchorsWeightSqrtGeom(mention, anchorAndOccurrencies, 0.20));
		features.put("edit_distance_anchor_segment_sqrt_geometric_0.10", edAnchorsWeightSqrtGeom(mention, anchorAndOccurrencies, 0.10));
		features.put("edit_distance_anchor_segment_sqrt_geometric_0.05", edAnchorsWeightSqrtGeom(mention, anchorAndOccurrencies, 0.05));
		features.put("edit_distance_anchor_segment_sqrt_geometric_0.02", edAnchorsWeightSqrtGeom(mention, anchorAndOccurrencies, 0.02));
		features.put("expandibility_right",
		        expandibility(query, a.getPosition(), a.getPosition() + a.getLength(), anchorAndOccurrencies, true));
		features.put("expandibility_left",
		        expandibility(query, a.getPosition(), a.getPosition() + a.getLength(), anchorAndOccurrencies, false));
		features.put("expandibility_sum", features.get("expandibility_left") +features.get("expandibility_right"));
		return features;
	}
	...
	public static String[] getFeatureNamesStatic() {
		if (ftrNames == null) {
			...
			v.add("edit_distance_anchor_segment_sqrt_geometric_0.20");// 60
			v.add("edit_distance_anchor_segment_sqrt_geometric_0.10");
			v.add("edit_distance_anchor_segment_sqrt_geometric_0.05");
			v.add("edit_distance_anchor_segment_sqrt_geometric_0.02");
			v.add("expandibility_right");
			v.add("expandibility_left");
